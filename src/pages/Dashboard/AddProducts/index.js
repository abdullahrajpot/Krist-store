import { Col, Input, Row, Typography, Button, Form, Upload } from 'antd';
...
export default function AddProducts() {
    ...
    const handleFileChange = (e) => {
        setFile(e.file); // <-- Ensure you're getting the actual File object
    };
        ...
        <>
            <Row className="min-vh-100">
                ...
                <Col xs={24} sm={{ span: 24, offset: 4 }} md={{ span: 24, offset: 0 }} lg={24} className=" d-flex flex-column justify-content-center align-items-center text-center p-4 p-md-5">
                    ...
                    <Form className="w-50" layout='vertical' style={{ border: '1px solid gray', borderRadius: '10px', padding: '30px' }} onSubmitCapture={handleSubmit} >
